...
class AnalysisVarPass : public ir::Pass {
 ...
 private:
  ...
  void UpdateGraphDesc(ir::Node* var, ir::Node* cache_var, size_t idx) const;
  // update ir nodes
  void UpdateGraphNodes(ir::Node* var, ir::Node* cache_var, size_t idx) const;
  ...
  mutable details::OrderedNodePairPool pool;
  // controlflow Graph
